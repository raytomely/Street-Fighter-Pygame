...
palette_path="C:SFLIU220\\RGB.PAL"
sfibm_path="C:SFLIU220\\"
...
def character_select(player1_controls, player2_controls):
    ...
    four_kings_images=load_R(sfibm_path+'SKING.R',sfibm_path+'SKING.ID',PALETTE)
    i = 0
    j = 8
    ...
    images=load_R(sfibm_path+'FACSW.R',sfibm_path+'FACSW.ID',PALETTE)
    for image in images:
        image_scaled_size = (image['width']*SCALE, image['height']*SCALE)
    ...
    characters = [[{'name':'RYU', 'portrait':images[0]['image'], 'RE':'SUPRYU.RE', 'IDE':'SUPRYU.IDE', 'SEQ':'SUPRYU.SEQ', 'KEY':'SUPRYU.KEY','background':'HYPRYU.BK'},
                   {'name':'E.HONDA', 'portrait':images[1]['image'], 'RE':'HYPHONDA.RE', 'IDE':'HYPHONDA.IDE', 'SEQ':'SUPHONDA.SEQ', 'KEY':'SUPHONDA.KEY','background':'HYPHONDA.BK'},
                   {'name':'BLANKA', 'portrait':images[2]['image'], 'RE':'HYPBLANK.RE', 'IDE':'HYPBLANK.IDE', 'SEQ':'SUPBLANK.SEQ', 'KEY':'SUPBLANK.KEY','background':'HYPBLANK.BK'},
                   {'name':'GUILE', 'portrait':images[3]['image'], 'RE':'HYPGUILE.RE', 'IDE':'SUPGUILE.IDE', 'SEQ':'SUPGUILE.SEQ', 'KEY':'SUPGUILE.KEY','background':'HYPGUILE.BK'},
                   {'name':'BALROG', 'portrait':images[4]['image'], 'RE':'HYPBAL.RE', 'IDE':'SUPBAL.IDE', 'SEQ':'SUPBAL.SEQ', 'KEY':'SUPBAL.KEY','background':'HYPBAL.BK'},
                   {'name':'VEGA', 'portrait':images[5]['image'], 'RE':'SUPVEGA.RE', 'IDE':'SUPVEGA.IDE', 'SEQ':'SUPVEGA.SEQ', 'KEY':'SUPVEGA.KEY','background':'HYPVEGA.BK'}],
                  [{'name':'KEN', 'portrait':images[6]['image'], 'RE':'HYPKEN.RE', 'IDE':'HYPKEN.IDE', 'SEQ':'SUPKEN.SEQ', 'KEY':'SUPKEN.KEY','background':'HYPKEN.BK'},
                   {'name':'CHUN-LI', 'portrait':images[7]['image'], 'RE':'HYPCHUN.RE', 'IDE':'SUPCHUN.IDE', 'SEQ':'SUPCHUN.SEQ', 'KEY':'SUPCHUN.KEY','background':'HYPCHUN.BK'},
                   {'name':'ZANGIEF', 'portrait':four_kings_images[0]['image'], 'RE':'HYPZANG.RE', 'IDE':'HYPZANG.IDE', 'SEQ':'SUPZANG.SEQ', 'KEY':'SUPZANG.KEY','background':'HYPZANG.BK'},
                   {'name':'DHALSIM', 'portrait':four_kings_images[1]['image'], 'RE':'HYPDHAL.RE', 'IDE':'SUPDHAL.IDE', 'SEQ':'SUPDHAL.SEQ', 'KEY':'SUPDHAL.KEY','background':'HYPDHAL.BK'},
                   {'name':'SAGAT', 'portrait':four_kings_images[2]['image'], 'RE':'HYPSAGAT.RE', 'IDE':'SUPSAGAT.IDE', 'SEQ':'SUPSAGAT.SEQ', 'KEY':'SUPSAGAT.KEY','background':'HYPSAGAT.BK'},
                   {'name':'M.BISON', 'portrait':four_kings_images[3]['image'], 'RE':'HYPBISON.RE', 'IDE':'SUPBISON.IDE', 'SEQ':'SUPBISON.SEQ', 'KEY':'SUPBISON.KEY','background':'HYPBISON.BK'}]]
    player1_column_index = 0
    player1_row_index = 0
    player1_character = characters[player1_row_index][player1_column_index]
    player1_character_pos =[-10, 420-player1_character['portrait'].get_height()]
    player2_column_index = 0
    player2_row_index = 1
    player2_character = characters[player2_row_index][player2_column_index]
    player2_character_pos =[640-player2_character['portrait'].get_width()+10, 420-player2_character['portrait'].get_height()]
    player1_choice = None
    player2_choice = None
    character1 = None
    character2 = None
...
def title_screen():
    ...
    image_path = sfibm_path + "SUPTL.229"
    with open(image_path, 'rb') as file:
